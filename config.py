...
DISTORTION_CLASSIFIER_MODEL_PATH = os.path.join(DIR_NAME, "appEdge", "api", "models", "distortionNetV2.pth")
...
#EDGE_BLUR_MODEL_PATH = "./appEdge/api/services/models/total_gaussian_blur_distorted_model_mobilenet_caltech_21_7.pth"
#Inference Time Result Paths of EDGE MODEL
RESULTS_INFERENCE_TIME_EDGE = os.path.join(DIR_NAME, "appEdge", "api", "services", "result")

save_idx_path = os.path.join(DIR_NAME, "save_idx_b_mobilenet_caltech_21.npy")
dataset_path = os.path.join(DIR_NAME, "dataset", "256_ObjectCategories")
